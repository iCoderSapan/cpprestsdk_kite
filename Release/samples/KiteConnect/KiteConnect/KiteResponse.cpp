...
namespace KiteConnect
{
    ...
    /*class KiteResponse
    {
        ...
        public:
            KiteResponse(web::http::http_response);
            http_response getRaw();
            json::value getJSONData();
            string getCSVData();
            string getData();
    };*/
    KiteResponse::KiteResponse(web::http::http_response resp):response(resp) {}

    inline http_response& KiteResponse::getRaw()
    {
        return response;
    }

    inline json::value KiteResponse::GetJSONData()
    {
        return response.extract_json().get();
    }

    inline string KiteResponse::GetCSVData()
    {
